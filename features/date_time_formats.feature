Feature: Check that Dates and/or Dates and Times in UK and ISO formats are accepted and those that aren't are rejected
  ...
  Scenario Outline: Date/Time - Correct error message displayed where format is incorrect
    ...
    Examples:
      ...
      | CUKE6001_Monitoring_Date_Future_Date_UK_FS_ddmmyyyy_FAIL.csv               | DR9020 | Mon_Date | Incorrect |
      | CUKE6002_Monitoring_Date_Future_Date_ISO_yyyymmdd_FAIL.csv                 | DR9020 | Mon_Date | Incorrect |
      | CUKE6003_Monitoring_Date_Future_Date_ISO_ddmmyyyy_FAIL.csv                 | DR9020 | Mon_Date | Incorrect |
      | CUKE6005_Monitoring_Date_UK_invalid_FS_YYYYMMDD_FAIL.csv                   | DR9020 | Mon_Date | Incorrect |
      | CUKE6006_Monitoring_Date_UK_invalid_FS_MMDDYYYY_FAIL.csv                   | DR9020 | Mon_Date | Incorrect |
      | CUKE6009_Monitoring_Date_ISO_invalid_YYYY-DD-MM_FAIL.csv                   | DR9020 | Mon_Date | Incorrect |
      | CUKE6010_Monitoring_Date_invalid_format_MM.DD.YYYY_FAIL.csv                | DR9020 | Mon_Date | Incorrect |
      | CUKE6011_Monitoring_Date_invalid_format_YYYY.MM.DD_FAIL.csv                | DR9020 | Mon_Date | Incorrect |
      | CUKE6012_Monitoring_Date_Time_ISO_invalid_yyyymmddT01_01_60_FAIL.csv       | DR9020 | Mon_Date | Incorrect |
      | CUKE6013_Monitoring_Date_Time_ISO_Invalid_yyyymmddSpace01_01_60_FAIL.csv   | DR9020 | Mon_Date | Incorrect |
      | CUKE6014_Monitoring_Date_Time_ISO_Invalid_ddmmyyyyT01_01_60_FAIL.csv       | DR9020 | Mon_Date | Incorrect |
      | CUKE6015_Monitoring_Date_Time_ISO_Invalid_ddmmyyyySpace01_01_60_FAIL.csv   | DR9020 | Mon_Date | Incorrect |
      | CUKE6016_Monitoring_Date_Time_UK_invalid_FS_ddmmyyyyT01_01_60_FAIL.csv     | DR9020 | Mon_Date | Incorrect |
      | CUKE6017_Monitoring_Date_Time_UK_invalid_FS_ddmmyyyySpace01_01_60_FAIL.csv | DR9020 | Mon_Date | Incorrect |
