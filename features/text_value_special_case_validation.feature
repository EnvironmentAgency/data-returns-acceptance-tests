  ...
  Scenario Outline: Successfully submit a valid file where either text value or value are given
    ...
    * I expect the row correction details for error <DRref> to be shown
    ...
    Examples:
      ...
      | CUKE7029_Text_Value_and_Value_and_unit_FAIL.csv                   | DR9050   | (Multiple)  | Conflicting  | # Fix
      ...
      | CUKE7032_No_Text_Value_and_No_Value_no_headers_Units_FAIL.csv     | DR9999   | Value       | Missing      | # Fix
